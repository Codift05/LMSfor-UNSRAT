# PROPOSAL APLIKASI EDUDESK

## 1. Cover
**Judul Aplikasi:** EduDesk - Desktop-based Learning Management System
...
## 3. Users (Aktor)
EduDesk dirancang dengan 3 (tiga) peran pengguna utama. Masing-masing memiliki batasan wewenang dan alur navigasi yang spesifik.

1. **Student (Siswa):**
   - **Deskripsi:** Pengguna yang menggunakan EduDesk untuk mengonsumsi materi pembelajaran.
...
EduDesk menggunakan teknologi *Material 3 Design* pada Compose Desktop, yang menjamin tampilannya modern, bersih (clean), dan estetik. Model kerangka/wireframe utamanya disajikan lewat pola hierarki berikut:
